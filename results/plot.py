...
plt.plot(gagg_ags05[:,0], gagg_ags05[:,1]/1.0e10, '--', color='mediumorchid', label=r'AGS05')
...
plt.plot(gagg_ags05[:,0], gagg_ags05[:,1]/gagg_b16agss09[:,1] - 1.0, '--', color='mediumorchid', label=r'AGS05')
...
plt.plot(gaee_ags05[:,0], gaee_ags05[:,1]/1.0e8, '--', color='mediumorchid', label=r'AGS05')
...
plt.plot(gaee_ags05[:,0], gaee_ags05[:,1]/gaee_b16agss09[:,1] - 1.0, '--', color='mediumorchid', label=r'AGS05')
