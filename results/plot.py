...
plt.plot(gagg_bs05agsop[:,0], gagg_bs05agsop[:,1]/1.0e10, '-.', color='yellowgreen', label=r'BS05-ABSOP')
...
plt.plot(gagg_bp00[:,0], gagg_bp00[:,1]/gagg_agss09met[:,1] - 1.0, '-', color='orange', label=r'BP00')
plt.plot(gagg_bp04[:,0], gagg_bp04[:,1]/gagg_agss09met[:,1] - 1.0, ':', color='mediumvioletred', label=r'BP04')
plt.plot(gagg_bs05op[:,0], gagg_bs05op[:,1]/gagg_agss09met[:,1] - 1.0, '--', color='saddlebrown', label=r'BS05-OP')
plt.plot(gagg_bs05agsop[:,0], gagg_bs05agsop[:,1]/gagg_agss09met[:,1] - 1.0, '-.', color='yellowgreen', label=r'BS05-ABSOP')
...
plt.plot(gaee_bp00[:,0], gaee_bp00[:,1]/1.0e10, '-', color='orange', label=r'BP00')
plt.plot(gaee_bp04[:,0], gaee_bp04[:,1]/1.0e10, ':', color='mediumvioletred', label=r'BP04')
plt.plot(gaee_bs05op[:,0], gaee_bs05op[:,1]/1.0e10, '--', color='saddlebrown', label=r'BS05-OP')
plt.plot(gaee_bs05agsop[:,0], gaee_bs05agsop[:,1]/1.0e10, '-.', color='yellowgreen', label=r'BS05-AGSOP')
...
plt.plot(gaee_bp00[:,0], gaee_bp00[:,1]/gaee_agss09met[:,1] - 1.0, '-', color='orange', label=r'BP00')
plt.plot(gaee_bp04[:,0], gaee_bp04[:,1]/gaee_agss09met[:,1] - 1.0, ':', color='mediumvioletred', label=r'BP04')
plt.plot(gaee_bs05op[:,0], gaee_bs05op[:,1]/gaee_agss09met[:,1] - 1.0, '--', color='saddlebrown', label=r'BS05-OP')
plt.plot(gaee_bs05agsop[:,0], gaee_bs05agsop[:,1]/gaee_agss09met[:,1] - 1.0, '-.', color='yellowgreen', label=r'BS05-AGSOP')
