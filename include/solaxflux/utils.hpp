...
const int op_grid [op_grid_size][2] = { {150,54}, {150,56}, {152,54}, {152,56}, {156,68}, {158,68}, {158,70}, {160,64}, {160,66}, {160,68}, {160,70}, {162,64}, {162,66}, {162,68}, {162,70}, {162,72}, {164,66}, {164,68}, {164,70}, {164,72}, {166,66}, {166,68},
    {166,70}, {166,72}, {166,74}, {168,68}, {168,70}, {168,72}, {168,74}, {168,76}, {170,70}, {170,72}, {170,74}, {172,72}, {172,74}, {170,76}, {172,76}, {172,78}, {174,74}, {174,76}, {174,78}, {176,74}, {176,76}, {176,78}, {176,80}, {178,76}, {178,78}, {178,80},
    {180,76}, {180,78}, {180,80}, {182,78}, {182,80}, {182,82}, {184,78}, {184,80}, {184,82}, {186,78}, {186,80}, {186,82}, {188,80}, {188,82}, {190,80}, {190,82}, {190,84}, {192,80}, {192,82}, {192,84}, {194,80}, {194,82}, {194,84}, {196,80}, {196,82}, {196,84},
...
const std::set<std::pair<int,int>> unavailable_OP = { {150,66}, {150,68}, {150,70}, {152,66}, {152,68}, {152,70}, {154,68}, {154,70}, {156,70} };
...
class Nucleartransition {
  public:
    Nucleartransition();
    Nucleartransition(double energy, double nuclmass, std::string element, double isotope_fraction, double excitedJ, double groundJ, double delta, double beta, double mu0, double mu3, double eta, double tau, double nperrho);
