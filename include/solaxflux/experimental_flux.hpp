...
//////////////////////////////////////////////////////////////
//  Data and structures for various helioscope experiments  //
//////////////////////////////////////////////////////////////

// Names of experiments and mapping functions
...
// Structure that contains all relevant experimental parameters
// N.B. Energy resolution not fully implemented, yet!
...
// CAST 2007 setup and results [hep-ex/0702006; 2004 CCD measurement]
...
// CAST 2017 setup [arXiv:1705.02290; all detectors]
...
// Conversion probability into (massless) axions, (gagg*B*L/2)^2, in a reference magnetic field with B = 9.0 T, L = 9.26 m, and gagg = 10^-10 GeV^-1 (CAST values).
...
struct exp_flux_from_file_integration_parameters { double mass; double length; std::string dataset; OneDInterpolator* spectral_flux; double support [2]; double sigma; };
...
std::vector<std::vector<double>> axion_reference_counts_from_file(exp_setup *setup, std::vector<double> masses, std::string spectral_flux_file_gagg,
                                                                  std::string spectral_flux_file_gaee = "", std::string saveas = "", bool save_convolved_spectra=false);
