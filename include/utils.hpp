...
const std::vector<std::string> alpha_available = {"data/SolarModel_AGS05.dat","data/SolarModel_AGSS09.dat","data/SolarModel_AGSS09ph.dat","data/SolarModel_B16-AGSS09.dat","data/SolarModel_B16-GS98.dat","data/SolarModel_GS98.dat"};
