...
class Isotope {
   public:
      Isotope() {};
      Isotope(std::string s, int a) { el_name = s; el_a_value = a; };
      Isotope(std::pair<std::string,int> p) { el_name = p.first; el_a_value = p.second; };
      Isotope(std::string s) { el_name = s; el_a_value = 0; };
