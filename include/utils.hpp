...
const std::map<Element, double> el_avg_weight ({ {{"H",1}, 1.007825}, {{"He",4}, 4.002603}, {{"He",3}, 3.016029}, {{"C",12}, 12.000000}, {{"C",13}, 13.003355}, {{"N",14}, 14.003074}, {{"N",15}, 15.000109}, {{"O",16}, 15.994915},
...
const std::vector<Element> op_elements_new = {{"H",1}, {"He",3}, {"He",4}};
...
class SolarModel
{
  ...
  private:
    ...
    int num_tracked_elems;
    std::vector<Element> tracked_elems;
